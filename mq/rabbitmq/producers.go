...
// 初始化生产者,连接mq服务器
func InitProducers(url, exchangeName string, durable bool) (*Producers, error) {
	...
	return &Producers{ch, exchangeName, persistent}, nil
}

// 发送消息
func (p *Producers) Publish(routingKey string, payload interface{}) error {
